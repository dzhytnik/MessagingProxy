...
@Component
public class JMSKafkaConsumer implements JMSConsumer{
    @Autowired
    ...
    private Consumer<Long, String> createConsumer() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, KafkaClient.VARUS_MESSAGING_SERVICE_KAFKA_SERVER);
        ...
        consumer.subscribe(Collections.singletonList(KafkaClient.VARUS_MESSAGING_TOPIC));
        return consumer;
    }
